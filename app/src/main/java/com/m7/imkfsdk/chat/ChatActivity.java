...
import com.odbpo.fenggou.im_rlqm_kf.R;
...
//                Toast.makeText(getApplicationContext(), break_tips, Toast.LENGTH_LONG).show();
     ...
     * @param fromToMessage
     */
//    private void voiceToText(final String newFilePath, final FromToMessage fromToMessage) {
//        mIatResults.clear();
...
//                if (b) {
//                    dealResult(recognizerResult, fromToMessage, newFilePath);
//                } else {
...
//    private void dealResult(RecognizerResult results, FromToMessage fromToMessage, String newFilePath) {
//        String text = JsonParser.parseIatResult(results.getResultString());
//
//        String sn = null;
//        // 读取json结果中的sn字段
...
//        System.out.println("语音转文本后的文字是：" + voiceText);
    ...
    class KeFuStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (IMChatManager.ROBOT_ACTION.equals(action)) {
                ...
                Toast.makeText(ChatActivity.this, "tcp状态是:"+tcpstatus, Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//            cust.put("姓名", "李三");
//            jsonObject.put("customField", URLEncoder.encode(cust.toString()));
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
